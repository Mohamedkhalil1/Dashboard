                ...
                <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="widget-user-header text-white" style="background: url('./images/cover-user.jpg') center center;">
                                    <h3 class="widget-user-username text-right">Mohamed Khalil</h3>
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" id="inputExperience" placeholder="Biography"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="file" class="form-control" id="avatar" placeholder="Email">
                        </div>
                      </div>
